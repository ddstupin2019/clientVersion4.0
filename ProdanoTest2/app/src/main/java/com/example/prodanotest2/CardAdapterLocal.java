...
public class CardAdapterLocal extends ArrayAdapter<Card> {
    ArrayList<Card> list;
    public CardAdapterLocal(@NonNull Context context, @NonNull ArrayList<Card> objects) {
